        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground text-lg font-light leading-relaxed">
              ...
              <p>
                Today, I operate out of Agartala, advising startups, scaling products, and navigating the complexities of international tech policy. I founded <strong className="text-white font-medium">ATSFy Technologies</strong> to fix broken recruitment pipelines and <strong className="text-white font-medium">Green-to-Gold</strong> to turn sustainability into a revenue center. Alongside, I've shipped <strong className="text-white font-medium">VentureVal</strong> for investor-grade startup evaluation, <strong className="text-white font-medium">TeeVibe</strong> for premium streetwear commerce, <strong className="text-white font-medium">IntelliFinance</strong> for AI-powered personal finance, the <strong className="text-white font-medium">MedTech Opportunity in Tripura</strong> blueprint for Northeast India healthcare, and the broader <strong className="text-white font-medium">ATSFy Ecosystem</strong> — an interconnected AI infrastructure layer emerging from the Northeast for India and beyond.
              </p>
              <p>
